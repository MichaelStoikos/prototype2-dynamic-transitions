			...
			<div className="crew">
				<div className="crew-list">
					{Object.keys(crewMembers).map((key) => (
						<div key={key} className={`crew-member ${selectedCrew === key ? "active" : ""}`} onClick={() => handleSelectCrew(key)}>
				...
				<div className="crew-details">
					...
					<div className="crew-info">
						...
						<p>
							PSYCHOLOGICAL:{" "}
							<Typewriter
								key={`psychological-${selectedCrew}`}
								options={{ autoStart: true, loop: false, delay: 60 }}
								onInit={(typewriter) => {
						...
						<p className="medicalStatus">
							<Typewriter
								key={`classified-${selectedCrew}`}
								options={{ autoStart: true, loop: false, delay: 60 }}
								onInit={(typewriter) => {
